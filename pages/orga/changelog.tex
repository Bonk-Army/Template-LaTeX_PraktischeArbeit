...
\begin{description}
	\item[2022/09/06 - NH/2] Multiple Changes about Keywords \& some Graphs
	\item[2022/09/06 - NH] Added Template to correctly display the Acronyms (descriptionCustom)
	\item[2022/07/12 - NH] Added theorem environments
	\item[2022/07/11 - NH] Added a way to black out Text
	\item[2022/07/07 - NH] Changed the Size of the DHBW Logo
