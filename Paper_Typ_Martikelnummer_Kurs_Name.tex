...
%————————————————————————————————————————————————————————————————————————————
\addbibresource{./directories/bibliography}
...
\begin{document}
	...
	%	geben.
	%\include{pages/content/kapitel1}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	...
	%\include{pages/content/kapitel2}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	...
	%\include{pages/content/kapitel3}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	%	Kapitel 4ff Methodik und Umsetzung Hauptteil der Arbeit – hier zunächst die 
	%	Konzeption, danach die Realisierung beschreiben.
	%\include{pages/content/kapitel4}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	%\include{pages/content/kapitel5}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	...
	%\include{pages/content/kapitel6}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	...
	%\include{pages/content/kapitel7}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	...
	%\include{pages/content/kapitel8}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
	...
	%\include{pages/content/kapitel9}	\ifthenelse{\boolean{DEBUG}}{}{\cleardoublepage}
